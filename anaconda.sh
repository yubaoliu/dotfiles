...
__conda_setup="$('/home/yubao/data/software/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/yubao/software/data/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/yubao/software/data/anaconda3/etc/profile.d/conda.sh"
    else
