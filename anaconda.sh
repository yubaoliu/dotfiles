...
__conda_setup="$('/home/yubao/data/software/anaconda2/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/yubao/data/software/anaconda2/etc/profile.d/conda.sh" ]; then
        . "/home/yubao/data/software/anaconda2/etc/profile.d/conda.sh"
    else
        export PATH="/home/yubao/data/software/anaconda2/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
