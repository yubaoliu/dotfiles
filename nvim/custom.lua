return { -- The default '<leader>' is the space. leader = " ",


	-- Windows
    -- noremap <Leader>" <Esc>:vsplit<CR>
    -- vim.api.nvim_set_keymap('n', '<Leader>|', '<Esc>:vsplit<CR>',  {noremap = true}),
    -- vim.keymap.set({'n', 'v'}, '<Space>|', '<Esc>:vsplit<CR>'),
    -- vim.keymap.set({'n', 'v'}, '<Space>-', '<Esc>:split<CR>'),
